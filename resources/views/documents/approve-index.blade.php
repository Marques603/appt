<x-app-layout>
    <x-page-title page="Documentos" header="Lista de Documentos Aprovação" />
    ...
    <div class="space-y-4">
        <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
            <div class="flex w-full flex-col items-stretch gap-2 sm:flex-row sm:items-center sm:justify-start md:w-auto md:flex-1">
                <form method="GET" action="{{ route('documentsapprove.index') }}" class="group flex h-10 w-full items-center rounded-primary border border-transparent bg-white shadow-sm focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-inset focus-within:ring-primary-500 dark:bg-slate-800 sm:max-w-xs">
        ...
        <ul class="dropdown-list space-y-4 p-4">
            <li class="dropdown-list-item">
                ...
                <ul class="list-disc pl-5 text-sm space-y-1">
                    ...
                    <div class="dropdown-content w-72 !overflow-visible">
                        <form method="GET" action="{{ route('documentsapprove.index') }}">
                            <ul class="dropdown-list space-y-4 p-4">
                                <li class="dropdown-list-item">
