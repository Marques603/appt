...
<div class="card">
    <div class="card-body">
        ...
        <p class="mb-4 text-sm font-normal text-slate-400">
            Digite o nome ou CPF/CNPJ para buscar dados existentes
        </p>

        <form method="GET" action="{{ route('visitors.create') }}" class="space-y-4">
            <label for="search" class="sr-only">Buscar por nome ou CPF/CNPJ</label>
            <input
                type="text"
                id="search"
                name="search"
