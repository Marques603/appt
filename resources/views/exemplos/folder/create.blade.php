<x-app-layout>
    <!-- Título da Página -->
    <x-page-title page="Lista de Pastas" pageUrl="{{ route('folder.index') }}" header="{{ isset($folder) ? 'Editar Pastas' : 'Criar Pasta' }}" />
        ...
        <section class="col-span-1 flex w-full flex-1 flex-col gap-6 lg:col-span-3 lg:w-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ isset($folder) ? route('folder.update', $folder) : route('folder.store') }}" class="flex flex-col gap-6">
                        @csrf
