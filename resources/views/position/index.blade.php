<x-app-layout>
        ...
        <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
            ...
            <div class="flex w-full items-center justify-between gap-x-4 md:w-auto">
              ...
              <span class="hidden sm:inline-block">Exportar</span>
                ...
                <a class="btn btn-primary" href="{{ route('position.create') }}" role="button">
    ...
    @else
        {{ $count }} colaborador{{ $count > 1 ? 'es' : '' }}
            @endif
                            ...
                            <td class="text-right">
                                    ...
                                    <div class="dropdown" data-placement="bottom-start">
                                        ...
                                        <div class="dropdown-content">
                                            <ul class="dropdown-list">
                                                <li class="dropdown-list-item">
                                                    <a href="{{ route('position.edit', $position->id) }}" class="dropdown-link">
                                                        <i class="h-5 text-slate-400" data-feather="edit"></i>
                                                        <span>Editar</span>
                                                    </a>
                                                </li>
                                                <li class="dropdown-list-item">
                                                    <a href="javascript:void(0)" class="dropdown-link" data-toggle="modal" data-target="#deleteModal-{{ $position->id }}">
                                ...
                                <div class="modal modal-centered" id="deleteModal-{{ $position->id }}">
        ...
        <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row">
            ...
            {{ $positions->appends(request()->query())->links('vendor.pagination.custom') }}
        </div>
    </div>
</x-app-layout>
